...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/MSTAR/train/exp/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--source', type=str, default='./data/MSTAR/tank/', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default='runs/MSTAR/detect', help='save results to project/name')
